document.addEventListener("DOMContentLoaded", function () {
  ...
  async function loadGameCategories() {
    const CATEGORIES_API_URL = "https://ydvassdp.com:5002/YDGames/api/YDGames/YDGames/GetAllGames";
    try {
  ...
  async function loadGameData() {
    const API_URL = "https://ydvassdp.com:5002/YDGames/api/YDGames/YDGames/GetAllGames";
    try {
